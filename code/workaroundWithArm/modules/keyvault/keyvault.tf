...
# resource "azurerm_key_vault_key" "key_vault_key" {  # Requires access to dataplane which is why we make use of azapi
#   name         = "cmk"
...
# resource "azapi_resource" "key_vault_key" {  # We can switch back to azapi once it is allow-listed
